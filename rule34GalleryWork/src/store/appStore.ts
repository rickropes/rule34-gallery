...
interface AppStore {
 ...
 selectedMedia:MediaRecord|null; selectedIds:number[]; galleryMedia:MediaRecord[]; search:string; addedFrom:string; addedTo:string; libraryVersion:number; viewerOpen:boolean;
 setLibraryPath:(v:string|null)=>void; setLibraryStatus:(v:LibraryStatus)=>void; setLibraryError:(v:string|null)=>void;
 setSelectedMedia:(v:MediaRecord|null)=>void; setGalleryMedia:(v:MediaRecord[])=>void; toggleSelected:(media:MediaRecord,additive:boolean)=>void; clearSelection:()=>void;
...
export const useAppStore=create<AppStore>((set)=>({
 libraryPath:null,libraryStatus:"loading",libraryError:null,selectedMedia:null,selectedIds:[],galleryMedia:[],search:"",addedFrom:"",addedTo:"",libraryVersion:0,viewerOpen:false,
 ...
 setSelectedMedia:selectedMedia=>set({selectedMedia,selectedIds:selectedMedia?[selectedMedia.id]:[]}),setGalleryMedia:galleryMedia=>set({galleryMedia}),
